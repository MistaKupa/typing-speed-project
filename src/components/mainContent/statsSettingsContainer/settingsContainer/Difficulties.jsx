...
export default function Difficulties({ current, onSelect }) {
  const [isOpen, setIsOpen] = useState(false);

  return (
    <>
      {/* DIFFICULTY CONTAINER MOBILE*/}
      ...
      {/* DIFFICULTY CONTAINER TABLET-DESKTOP*/}
      <div
        className={cn(
          "hidden",
      ...
      >
        <p className="text-neutral-400 pr-100">Difficulty:</p>
        ...
        {DIFFICULTIES.map((difficulty) => (
          <button
            ...
            className={cn(
              ...
              {
                "text-blue-400 border-blue-400": current === difficulty,
              },
            )}
          >
            {difficulty}
